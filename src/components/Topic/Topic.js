    ...
    return (
        <div className='shadow-lg bg-gradient-to-b from-cyan-700 to-blue-800 rounded-2xl p-4 w-96 text-white'>
            ...
            <div className='my-8  text-center'>
                <Link to={`/topic/${id}`} className='text-white bg-opacity-80 bg-slate-800 font-bold rounded-xl  py-2 px-24'>Start Quiz  <FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon></Link>
            </div>
            </div>
        </div>
    );
